...
return {
	...
	------------------------------------ fonts -------------------------------------
	--------------------------------------------------------------------------------
	s({ trig = "trm" }, fmta("\\textrm{<>}", { d(1, get_visual) })),
	s({ trig = "tit" }, fmta("\\textit{<>}", { d(1, get_visual) })),
	s({ trig = "tbf" }, fmta("\\textbf{<>}", { d(1, get_visual) })),
	s({ trig = "ttt" }, fmta("\\texttt{<>}", { d(1, get_visual) })),
	s({ trig = "tsf" }, fmta("\\textsf{<>}", { d(1, get_visual) })),
	s({ trig = "tsc" }, fmta("\\textsc{<>}", { d(1, get_visual) })),
	--------------------------------------------------------------------------------
	----------------------------------- spacing ------------------------------------
	--------------------------------------------------------------------------------
	...
	---------------------------------- hyperlinks ----------------------------------
	--------------------------------------------------------------------------------
	s({ trig = "hr" }, fmta("\\href{<>}{<>}", { i(1, "url"), d(2, get_visual) })),
}
