return {
    ...
    keys = {
        ...
        { "<leader>ft", function() require("fzf-lua").colorschemes() end, desc = "Themes", },
        { "<leader>fd", function() require("fzf-lua").grep_cword() end,   desc = "Word under cursor", },
        { "<leader>fp", function() require("fzf-lua").git_files() end,    desc = "Git files", },
        { "<leader>fs", function() require("fzf-lua").git_status() end,   desc = "Git status", },
        { "<leader>fl", function() require("fzf-lua").resume() end,       desc = "Resume last search", },
    },
    config = function()
